...
@section('content')
    <section class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_20rem]">
        <article class="komsije-surface min-w-0 rounded-[2rem] p-6 sm:p-8">
            ...
            <h1 class="mt-3 break-words text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">{{ __('Napišite obaveštenje za :building', ['building' => $currentBuilding->name]) }}</h1>
