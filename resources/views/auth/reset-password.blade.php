...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('Reset password') }} | Komšije</title>
                ...
                <main class="flex flex-1 items-center justify-center py-8">
                    <div class="w-full max-w-md">
                        <section class="komsije-surface rounded-[2rem] p-6 sm:p-8">
                            ...
                            <h1 class="mt-4 text-2xl font-semibold text-[var(--komsije-dark)]">{{ __('Set a new password') }}</h1>
                            <p class="mt-3 text-sm leading-6 text-slate-600">{{ __('Choose a strong password for your account.') }}</p>
